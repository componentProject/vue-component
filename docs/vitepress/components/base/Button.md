...
::::demo
Button/showType/disabled
::::

示例：总是显示说明（`showType='content'`）
::::demo
Button/showType/content
::::
...
示例：点击防抖 600ms
::::demo
Button/interaction/debounce
::::

示例：点击节流 800ms
::::demo
Button/interaction/throttle
::::

示例：Promise 节流（执行异步前不再触发）
::::demo
Button/interaction/promise
:::: 

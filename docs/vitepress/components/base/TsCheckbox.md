...
多选框组件，支持静态数据和动态请求，支持灵活的布局和禁用规则。
...
:::demo
TsCheckbox/props/layout-flex
:::

grid布局

:::demo
TsCheckbox/props/layout-grid
:::
...
:::demo
TsCheckbox/props/labelKey-valueKey
:::
...
:::demo
TsCheckbox/props/disabledValues
:::
...
:::demo
TsCheckbox/props/disabledLabels
:::
...
:::demo
TsCheckbox/props/disabledHandler
:::

### 复选框属性（checkboxProps）

传递给 ElCheckbox 组件的属性对象。

:::demo
TsCheckbox/props/checkboxProps
:::
...
| `checkboxProps` | 传递给ElCheckbox的属性 | `Record<string, any>` | `{}` |

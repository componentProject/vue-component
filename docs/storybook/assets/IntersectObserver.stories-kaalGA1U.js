import{k as T,Q as M,R as P,C as Y,v as S,z as U,p as R,r as e}from"./vue.esm-bundler-DL_Z5ZQB.js";const O=T({__name:"index",props:{isIntersecting:{type:Boolean,default:!0},threshold:{type:Number,default:1},rootMargin:{type:Array,default:()=>[0,0,0,0]},observers:{type:Array,default:()=>[]},observerIds:{type:Array,default:()=>[]}},emits:["mutate","getTargets"],setup(F,{emit:s}){const m=F,p=s;let r=null,o,d;return M(()=>{r=document.getElementById("intersection-observer-box"),d=new ResizeObserver(i=>{for(const t of i)if(t.contentBoxSize){const B=Array.isArray(t.contentBoxSize)?t.contentBoxSize[0]:t.contentBoxSize,{blockSize:h,inlineSize:g}=B;o&&o.disconnect();const{threshold:x,isIntersecting:I,observers:y,observerIds:A}=m;let c="";m.rootMargin.forEach((l,n)=>{c+=`${n%2?-g*l:-h*l}px `}),o=new IntersectionObserver(l=>{l.forEach(n=>{console.log("entry",n),n.isIntersecting==I&&p("mutate",n)})},{root:r,rootMargin:c,threshold:[x]}),y.forEach(l=>{o.observe(l)});const u=A.reduce((l,n)=>(l[n]=document.getElementById(n),l),{});Object.values(u).forEach(l=>{o.observe(l)}),p("getTargets",u)}}),d.observe(r,{box:"content-box"})}),P(()=>{d.disconnect(),o.disconnect()}),(i,t)=>(R(),Y("div",U({id:"intersection-observer-box"},i.$attrs),[S(i.$slots,"default")],16))}});O.__docgenInfo={exportName:"default",displayName:"IntersectObserver",description:"",tags:{},props:[{name:"isIntersecting",description:"元素是否进入视口",type:{name:"boolean"},defaultValue:{func:!1,value:"true"}},{name:"threshold",description:"进入或离开视口的比例",type:{name:"number"},defaultValue:{func:!1,value:"1.0"}},{name:"rootMargin",description:`默认进入或离开容器触发监听,
如果设置了rootMargin，分别对应容器上右下左收缩的比例
例如[0,0,0.8,0] 代表仅监听0-20%高度部分`,type:{name:"array"},defaultValue:{func:!1,value:"[0, 0, 0, 0]"}},{name:"observers",description:"需要监听进入/离开容器的元素列表",type:{name:"array"},defaultValue:{func:!1,value:"[]"}},{name:"observerIds",description:"需要监听进入/离开容器的元素id列表",type:{name:"array"},defaultValue:{func:!1,value:"[]"}}],events:[{name:"mutate",description:"根据isIntersecting判断的进入或离开视口的元素"},{name:"getTargets",description:"根据observerIds获取到的元素组成的{id:target} 隐射对象"}],slots:[{name:"default"}],sourceFiles:["E:/project/component/vue-component/src/components/IntersectObserver/index.vue"]};const $={title:"可视化容器",component:O,args:{},argTypes:{isIntersecting:{control:"boolean",default:!0},rootMargin:{control:"array"},threshold:{control:"number"},observers:{control:"array"},observerIds:{control:"array"}}},v=()=>({template:`
  ...
  `,components:{IntersectObserver:O},setup(){const F=e("120px"),s=e({baseInfo:!0,hospitalInfo:!0,inAreaHealth:!0,allergy:!0,price:!0,isolationMark:!0}),m=e({}),p=e([{label:"身份证",value:"1"}]),r=e([{label:"已婚",value:"1"}]),o=e([{label:"医保",value:"1"}]),d=e([{label:"中国",value:"1"}]),i=e([{label:"汉",value:"1"}]),t=e([{label:"测试",value:"1"}]),B=e([{label:"trasen",value:"1"}]),h=e({}),g=e({}),x=e([{label:"过敏类型",prop:"allergyType"},{label:"过敏原名称",prop:"allergyOrigin"},{label:"过敏物/过敏药品",prop:"allergyDrug"},{label:"过敏症状",prop:"allergySymptom"},{label:"严重程度",prop:"allergyDegree"},{label:"首次发现时间",prop:"allergyTime",type:"date"},{label:"首次发现机构",prop:"firstDiscoverUnit"},{label:"记录时间",prop:"recordTime",type:"date"},{label:"记录人",prop:"recordName"}]),I=e([{allergyType:"过敏类型",allergyOrigin:"过敏原名称",allergyDrug:"过敏物/过敏药品",allergySymptom:"过敏症状",allergyDegree:"严重程度",allergyTime:"首次发现时间",firstDiscoverUnit:"首次发现机构",recordTime:"记录时间",recordName:"记录人"}]),y=e({}),A=e([{label:"飞沫隔离",value:"1"},{label:"接触隔离",value:"2"},{label:"空气隔离",value:"3"}]),c=e([]),u=e([{name:"基本信息",id:"baseInfo",target:null},{name:"住院信息",id:"hospitalInfo",target:null},{name:"入区健康信息",id:"inAreaHealth",target:null},{name:"过敏信息",id:"allergy",target:null},{name:"费用信息",id:"price",target:null},{name:"隔离标识",id:"isolationMark",target:null}]);let l=null,n=null,j,w;const b=e(!1),D=e("baseInfo");return{labelWidth:F,list:u,activeListItem:D,hasScroll:b,disabledObj:s,idTypeOptions:p,nationalityOptions:d,nationOptions:i,maritalStatusOptions:r,occupationTypeOptions:t,insuranceTypeOptions:o,workUnitOptions:B,patientBaseInfo:m,patientHospitalInfo:h,inAreaHealthInfo:g,patientPriceInfo:y,allergyColumns:x,allergyList:I,markList:A,isolationMark:c,rootElement:n,observer:j,resizeObserver:w,scrollToHandler:a=>{const f=u.value.find(k=>k.id===a).target;D.value=a,b.value=!0,clearTimeout(l),l=setTimeout(()=>{b.value=!1},1e3),f.scrollIntoView({block:"start",behavior:"smooth"})},getTargets:a=>{u.value.forEach(f=>{f.target=a[f.id]})},mutate:a=>{b.value||(D.value=a.target.getAttribute("id"))},editHandler:a=>{s.value[a]=!1},saveHandler:a=>{s.value[a]=!0}}}});var E,H,C;v.parameters={...v.parameters,docs:{...(E=v.parameters)==null?void 0:E.docs,source:{originalSource:`() => ({
  template: \`
    <div style="max-height: 400px" class="flex flex-1 overflow-hidden">
      <div class="list">
        <div
  ...
  setup() {
    ...
    const occupationTypeOptions = ref([{
      label: '测试',
      value: '1'
    }]);
...
})`,...(C=(H=v.parameters)==null?void 0:H.docs)==null?void 0:C.source}}};const G=["intersectObserver"];export{G as __namedExportsOrder,$ as default,v as intersectObserver};

<template>
  <div class="config-table">
    <!-- 表格标题区域 -->
    <div class="table-header" v-if="title || showExport">
    ...
    <!-- 搜索区域 -->
    <div class="table-search" v-if="searchConfig && searchConfig.length > 0">
          ...
          <template #default="scope">
            ...
            <template v-if="column.slots && column.slots.default">
              ...
              <template v-if="typeof column.slots.default === 'string'">
                <slot :name="column.slots.default" :row="scope.row" :index="scope.$index" :column="column"></slot>
              </template>
              <!-- 渲染函数方式 -->

          ...
          <div class="component-group mb-4" v-if="group.components.length > 0">
            ...
            <div class="grid grid-cols-2 gap-2">
              ...
              >
                <!-- 基础组件预览 -->
                <div
                  v-if="component.type === 'basic'"
                  class="component-preview mb-2 flex justify-center"
                >
                  <!-- 按钮预览 -->
                  <el-button
                  ...
                  <!-- 开关预览 -->
                  <el-switch v-else-if="component.id === 'el-switch'" disabled />
                ...
                <!-- 布局组件预览 -->
                <div
                  v-else-if="component.type === 'layout'"
                  class="component-preview mb-2 bg-gray-50 border border-dashed border-gray-300 p-1 rounded"
                >
                  <!-- 容器预览 -->
                  <div
                    v-if="component.id === 'el-container'"
                    class="bg-white h-10 w-full flex items-center justify-center text-xs text-gray-500"
                  >
                    容器
                  </div>
                  ...
                  <!-- 行预览 -->
                  <div
                    v-else-if="component.id === 'el-row'"
                    class="bg-white h-8 w-full flex flex-row items-center justify-between p-1 text-xs text-gray-500"
                  >
...
const filteredComponentGroups = computed(() => {
  try {
    ...
    return [
      {
        type: 'basic',
        components: filteredComponents.value.filter((comp) => comp.type === 'basic'),
      },
      {
        type: 'layout',
        components: filteredComponents.value.filter((comp) => comp.type === 'layout'),
      },
      {
        type: 'chart',
        components: filteredComponents.value.filter((comp) => comp.type === 'chart'),
      },
    ]
  } catch (error) {

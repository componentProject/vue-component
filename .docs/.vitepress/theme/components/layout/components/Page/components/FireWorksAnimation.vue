...
@keyframes bang {
  to {
    box-shadow: 161px -30.33333px #00ffdd, -157px -164.33333px #ff7300,
      -201px 28px #0040ff, 221px -184.33333px #ff00e1,
      72px 27px blue, 8px -82.33333px #ff0062, 140px -252.33333px #ffaa00,
      -14px 7px #7b00ff, -162px 46px #ff0900,
      ...
      -16px 16px #cc00ff, 214px -298.33333px #00eaff,
      -192px -18.33333px #00ccff, 20px -227.33333px #ff00ae,
      6px -30.33333px #ff0048, 175px 14px #ffe100,
      ...
      130px 53px #ffc800, -56px -97.33333px #b7ff00,
      ...
      -55px 33px #0048ff, -36px 66px #b7ff00,
      118px -160.33333px #00ff6a, 29px -28.33333px #9900ff,
      137px 2px #002fff, 242px -164.33333px #ff0059,
      -158px 10px #ff00cc, -62px -231.33333px #00ff11,
      -64px -111.33333px #c8ff00, -207px 44px #51ff00,
      -69px 9px #ff00ae, -83px -9.33333px #6600ff;
  }
}

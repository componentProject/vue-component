    ...
    >
        ...
        >
            ...
            <template #header v-if="isUserKnowNotice">
                ...
                <!-- 阻止mousedown冒泡导致不可点击 -->
                <div class="floating-panel-header-close" @click="isChatVisible = false" @mousedown.stop v-if="drag">
...
import { updateEmrData, initEmrObject, parseEmrData, clearEmrData } from './emrAgent/js/syncMonacoData';
...
export default {
    ...
    methods: {
        ...
        handleQuickAccessChange(item) {
            ...
            // 切换到新的智能体
            this.currentAgent = { ...item, isCache: this.agentStateCache.get(item.agentInfo.id) ? true : false };
            this.currentAgentId = item.agentInfo.id;
            this.currentView = 'chatAgent';

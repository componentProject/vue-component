...
export const initApiConfig = async (config) => {
...
export async function findAiCueWordDetailByAgentId(id) {
  ...
  const res = await fetch(
    `/ai-application/api/v1/ai/cueWord/findAiCueWordDetailByAgentId?${params}`,
    {
      method: "post",
      headers: {
        token: apiConfig.token,
...
export async function getConversationList(agentId) {
  ...
  const res = await fetch(
    `/ai-application/api/v1/ai/conversationDetail/getConversationListByUserId?${params}`,
    {
      method: "post",
      headers: {
        token: apiConfig.token,
...
export async function getDetailByConversationId(id) {
  ...
  const res = await fetch(
    `/ai-application/api/v1/ai/conversationDetail/getDetailByConversationId?${params}`,
    {
      method: "post",
      headers: {
        token: apiConfig.token,

<template>
  <div class="bubble-action">
    <button class="bubble-action__button" @click="handleOperation($event, 'replay')">
      <i class="ai-iconfont icon-refresh" />
    </button>
    <span class="bubble-action__refresh-line" />
    <button class="bubble-action__button" @click="handleOperation($event, 'copy')">
      <i class="ai-iconfont icon-copy" />
    </button>
    <span class="bubble-action__refresh-line" />
    <button
    ...
    >
      <i class="ai-iconfont icon-cc-thumbs-up" />
    </button>
    <span class="bubble-action__refresh-line" />
    <button
      class="bubble-action__button"
    ...
    >
      <i class="ai-iconfont icon-cc-thumbs-down" />
    </button>
    <slot />
  </div>
</template>
